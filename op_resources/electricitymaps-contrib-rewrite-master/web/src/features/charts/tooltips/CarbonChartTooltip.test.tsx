...
import { mockCarbonChartTooltipProps } from './CarbonChartTooltip.mock';
...
describe('<CarbonChartTooltip {...mockCarbonChartTooltipProps} />', () => {
  it('renders correctly', () => {
    const { container } = render(<CarbonChartTooltip {...mockCarbonChartTooltipProps} />);
