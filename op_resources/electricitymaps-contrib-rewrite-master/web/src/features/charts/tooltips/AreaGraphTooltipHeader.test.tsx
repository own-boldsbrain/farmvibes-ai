...
import { mockAreaGraphTooltipHeaderProps } from './AreaGraphTooltipHeader.mock';
...
describe('<AreaGraphTooltipHeader {...mockAreaGraphTooltipHeaderProps} />', () => {
  it('renders correctly', () => {
    const { container } = render(<AreaGraphTooltipHeader {...mockAreaGraphTooltipHeaderProps} />);
