...
import { mockAreaGraphTooltipProps } from './AreaGraphTooltip.mock';
...
describe('<AreaGraphTooltip {...mockAreaGraphTooltipProps} />', () => {
  it('renders correctly', () => {
    const { container } = render(<AreaGraphTooltip {...mockAreaGraphTooltipProps} />);
