...
import { mockEmissionChartTooltipProps } from './EmissionChartTooltip.mock';
...
describe('<EmissionChartTooltip {...mockEmissionChartTooltipProps} />', () => {
  it('renders correctly', () => {
    const { container } = render(<EmissionChartTooltip {...mockEmissionChartTooltipProps} />);
