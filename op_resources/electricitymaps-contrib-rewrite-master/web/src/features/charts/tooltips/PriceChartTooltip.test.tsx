...
import { mockPriceChartTooltipProps } from './PriceChartTooltip.mock';
...
describe('<PriceChartTooltip {...mockPriceChartTooltipProps} />', () => {
  it('renders correctly', () => {
    const { container } = render(<PriceChartTooltip {...mockPriceChartTooltipProps} />);
