...
import { mockBarBreakdownEmissionsChartProps } from './BarBreakdownEmissionsChart.mock';
...
describe('<BarBreakdownEmissionsChart {...mockBarBreakdownEmissionsChartProps} />', () => {
  it('renders correctly', () => {
    const { container } = render(<BarBreakdownEmissionsChart {...mockBarBreakdownEmissionsChartProps} />);
