...
import { mockBarElectricityBreakdownChartProps } from './BarElectricityBreakdownChart.mock';
...
describe('<BarElectricityBreakdownChart {...mockBarElectricityBreakdownChartProps} />', () => {
  it('renders correctly', () => {
    const { container } = render(<BarElectricityBreakdownChart {...mockBarElectricityBreakdownChartProps} />);
