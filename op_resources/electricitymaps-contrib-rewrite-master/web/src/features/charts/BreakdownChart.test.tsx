...
import { mockBreakdownChartProps } from './BreakdownChart.mock';
...
describe('<BreakdownChart {...mockBreakdownChartProps} />', () => {
  it('renders correctly', () => {
    const { container } = render(<BreakdownChart {...mockBreakdownChartProps} />);
