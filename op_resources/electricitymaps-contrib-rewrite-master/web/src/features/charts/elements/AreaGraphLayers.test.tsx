...
import { mockAreaGraphLayersProps } from './AreaGraphLayers.mock';
...
describe('<AreaGraphLayers {...mockAreaGraphLayersProps} />', () => {
  it('renders correctly', () => {
    const { container } = render(<AreaGraphLayers {...mockAreaGraphLayersProps} />);
