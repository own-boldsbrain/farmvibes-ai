...
import { mockGraphHoverlineProps } from './GraphHoverline.mock';
...
describe('<GraphHoverline {...mockGraphHoverlineProps} />', () => {
  it('renders correctly', () => {
    const { container } = render(<GraphHoverline {...mockGraphHoverlineProps} />);
