...
import { mockGraphBackgroundProps } from './GraphBackground.mock';
...
describe('<GraphBackground {...mockGraphBackgroundProps} />', () => {
  it('renders correctly', () => {
    const { container } = render(<GraphBackground {...mockGraphBackgroundProps} />);
