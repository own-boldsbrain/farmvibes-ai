...
import { mockEmissionChartProps } from './EmissionChart.mock';
...
describe('<EmissionChart {...mockEmissionChartProps} />', () => {
  it('renders correctly', () => {
    const { container } = render(<EmissionChart {...mockEmissionChartProps} />);
