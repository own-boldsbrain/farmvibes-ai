...
import { mockExchangeLayerProps } from './ExchangeLayer.mock';
...
describe('<ExchangeLayer {...mockExchangeLayerProps} />', () => {
  it('renders correctly', () => {
    const { container } = render(<ExchangeLayer {...mockExchangeLayerProps} />);
