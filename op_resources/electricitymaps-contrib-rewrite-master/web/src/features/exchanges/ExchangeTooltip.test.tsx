...
import { mockExchangeTooltipProps } from './ExchangeTooltip.mock';
...
describe('<ExchangeTooltip {...mockExchangeTooltipProps} />', () => {
  it('renders correctly', () => {
    const { container } = render(<ExchangeTooltip {...mockExchangeTooltipProps} />);
