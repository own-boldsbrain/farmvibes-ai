...
import { mockRankingPanelProps } from './RankingPanel.mock';
...
describe('<RankingPanel {...mockRankingPanelProps} />', () => {
  it('renders correctly', () => {
    const { container } = render(<RankingPanel {...mockRankingPanelProps} />);
