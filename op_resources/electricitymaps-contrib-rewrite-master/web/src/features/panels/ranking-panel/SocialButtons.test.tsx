...
import { mockSocialButtonsProps } from './SocialButtons.mock';
...
describe('<SocialButtons {...mockSocialButtonsProps} />', () => {
  it('renders correctly', () => {
    const { container } = render(<SocialButtons {...mockSocialButtonsProps} />);
