...
import { mockConcessionariasPanelProps } from './ConcessionariasPanel.mock';
...
describe('<ConcessionariasPanel {...mockConcessionariasPanelProps} />', () => {
  it('renders correctly', () => {
    const { container } = render(<ConcessionariasPanel {...mockConcessionariasPanelProps} />);
