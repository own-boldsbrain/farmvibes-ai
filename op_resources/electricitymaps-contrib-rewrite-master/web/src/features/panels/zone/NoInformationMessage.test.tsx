...
import { mockNoInformationMessageProps } from './NoInformationMessage.mock';
...
describe('<NoInformationMessage {...mockNoInformationMessageProps} />', () => {
  it('renders correctly', () => {
    const { container } = render(<NoInformationMessage {...mockNoInformationMessageProps} />);
