...
import { mockZoneHeaderTitleProps } from './ZoneHeaderTitle.mock';
...
describe('<ZoneHeaderTitle {...mockZoneHeaderTitleProps} />', () => {
  it('renders correctly', () => {
    const { container } = render(<ZoneHeaderTitle {...mockZoneHeaderTitleProps} />);
