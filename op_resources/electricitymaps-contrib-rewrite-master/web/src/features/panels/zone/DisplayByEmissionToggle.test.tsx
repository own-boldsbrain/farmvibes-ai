...
import { mockDisplayByEmissionToggleProps } from './DisplayByEmissionToggle.mock';
...
describe('<DisplayByEmissionToggle {...mockDisplayByEmissionToggleProps} />', () => {
  it('renders correctly', () => {
    const { container } = render(<DisplayByEmissionToggle {...mockDisplayByEmissionToggleProps} />);
