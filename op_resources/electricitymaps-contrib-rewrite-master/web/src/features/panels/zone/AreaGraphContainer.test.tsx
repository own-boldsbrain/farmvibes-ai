...
import { mockAreaGraphContainerProps } from './AreaGraphContainer.mock';
...
describe('<AreaGraphContainer {...mockAreaGraphContainerProps} />', () => {
  it('renders correctly', () => {
    const { container } = render(<AreaGraphContainer {...mockAreaGraphContainerProps} />);
