...
import { mockErrorBoundaryProps } from './ErrorBoundary.mock';
...
describe('<ErrorBoundary {...mockErrorBoundaryProps} />', () => {
  it('renders correctly', () => {
    const { container } = render(<ErrorBoundary {...mockErrorBoundaryProps} />);
