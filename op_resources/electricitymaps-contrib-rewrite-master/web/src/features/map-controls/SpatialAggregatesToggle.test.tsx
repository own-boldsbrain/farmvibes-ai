...
import { mockSpatialAggregatesToggleProps } from './SpatialAggregatesToggle.mock';
...
describe('<SpatialAggregatesToggle {...mockSpatialAggregatesToggleProps} />', () => {
  it('renders correctly', () => {
    const { container } = render(<SpatialAggregatesToggle {...mockSpatialAggregatesToggleProps} />);
