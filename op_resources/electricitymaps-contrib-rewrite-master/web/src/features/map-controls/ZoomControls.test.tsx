...
import { mockZoomControlsProps } from './ZoomControls.mock';
...
describe('<ZoomControls {...mockZoomControlsProps} />', () => {
  it('renders correctly', () => {
    const { container } = render(<ZoomControls {...mockZoomControlsProps} />);
