...
import { mockLanguageSelectorProps } from './LanguageSelector.mock';
...
describe('<LanguageSelector {...mockLanguageSelectorProps} />', () => {
  it('renders correctly', () => {
    const { container } = render(<LanguageSelector {...mockLanguageSelectorProps} />);
