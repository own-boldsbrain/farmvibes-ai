...
import { mockSettingsModalProps } from './SettingsModal.mock';
...
describe('<SettingsModal {...mockSettingsModalProps} />', () => {
  it('renders correctly', () => {
    const { container } = render(<SettingsModal {...mockSettingsModalProps} />);
