...
import { mockTimeControllerWrapperProps } from './TimeControllerWrapper.mock';
...
describe('<TimeControllerWrapper {...mockTimeControllerWrapperProps} />', () => {
  it('renders correctly', () => {
    const { container } = render(<TimeControllerWrapper {...mockTimeControllerWrapperProps} />);
