...
import { mockTimeControllerProps } from './TimeController.mock';
...
describe('<TimeController {...mockTimeControllerProps} />', () => {
  it('renders correctly', () => {
    const { container } = render(<TimeController {...mockTimeControllerProps} />);
